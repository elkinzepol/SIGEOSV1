...
<head>
  ...
  <!-- Datatables -->
  <link rel="stylesheet"
    href="<?php echo $functions->direct_sistema(); ?>/plugins/datatables-bs4/dataTables.bootstrap4.css">
  <link rel="stylesheet"
    href="<?php echo $functions->direct_sistema(); ?>/plugins/datatables/buttons.dataTables.min.css">
  <link rel="stylesheet"
    href="<?php echo $functions->direct_sistema(); ?>/plugins/datatables/buttons.bootstrap4.min.css">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
          <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="false">
            ...
            ?>
            <img src="<?php echo $user_avatar_url ?>" class="user-image img-circle elevation-2 bg-default"
              alt="User Image">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
            ...
            <div class="dropdown-divider"></div>
            <!-- Menu Footer -->
            <a id="logout-btn" href="<?php echo $functions->direct_sistema(); ?>/modules/end_session.php"
